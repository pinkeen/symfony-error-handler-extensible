...
class HtmlErrorRenderer implements ErrorRendererInterface
{
    ...
    protected function renderException(FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php'): string
    {
    ...
    protected function formatArgsAsText(array $args)
    {
    ...
    protected function abbrClass(string $class): string
    {
        $parts = explode('\\', $class);
    ...
    protected function getFileRelative(string $file): ?string
    {
     ...
     */
    protected function getFileLink(string $file, int $line)
    {
     ...
     */
    protected function formatFile(string $file, int $line, string $text = null): string
    {
        $file = trim($file);
     ...
     */
    protected function fileExcerpt(string $file, int $line, int $srcContext = 3): string
    {
    ...
    protected function fixCodeMarkup(string $line)
    {
    ...
    protected function formatFileFromText(string $text)
    {
    ...
    protected function formatLogMessage(string $message, array $context)
    {
    ...
    protected function addElementToGhost(): string
    {
